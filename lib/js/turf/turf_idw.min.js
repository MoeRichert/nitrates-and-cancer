...
},{"@turf/meta":14}],2:[function(require,module,exports){
...
},{"@turf/invariant":13}],3:[function(require,module,exports){
...
},{"@turf/helpers":9,"@turf/invariant":13}],4:[function(require,module,exports){
"use strict";function _interopDefault(n){return n&&"object"==typeof n&&"default"in n?n.default:n}function booleanWithin(n,o){var e=invariant.getType(n),t=invariant.getType(o),r=invariant.getGeom(n),i=invariant.getGeom(o);switch(e){case"Point":switch(t){case"MultiPoint":return isPointInMultiPoint(r,i);case"LineString":return booleanPointOnLine(r,i,{ignoreEndVertices:!0});case"Polygon":return booleanPointInPolygon(r,i,{ignoreBoundary:!0});default:throw new Error("feature2 "+t+" geometry not supported")}case"MultiPoint":switch(t){case"MultiPoint":return isMultiPointInMultiPoint(r,i);case"LineString":return isMultiPointOnLine(r,i);case"Polygon":return isMultiPointInPoly(r,i);default:throw new Error("feature2 "+t+" geometry not supported")}case"LineString":switch(t){case"LineString":return isLineOnLine(r,i);case"Polygon":return isLineInPoly(r,i);default:throw new Error("feature2 "+t+" geometry not supported")}case"Polygon":switch(t){case"Polygon":return isPolyInPoly(r,i);default:throw new Error("feature2 "+t+" geometry not supported")}default:throw new Error("feature1 "+e+" geometry not supported")}}function isPointInMultiPoint(n,o){var e,t=!1;for(e=0;e<o.coordinates.length;e++)if(compareCoords(o.coordinates[e],n.coordinates)){t=!0;break}return t}function isMultiPointInMultiPoint(n,o){for(var e=0;e<n.coordinates.length;e++){for(var t=!1,r=0;r<o.coordinates.length;r++)compareCoords(n.coordinates[e],o.coordinates[r])&&(t=!0);if(!t)return!1}return!0}function isMultiPointOnLine(n,o){for(var e=!1,t=0;t<n.coordinates.length;t++){if(!booleanPointOnLine(n.coordinates[t],o))return!1;e||(e=booleanPointOnLine(n.coordinates[t],o,{ignoreEndVertices:!0}))}return e}function isMultiPointInPoly(n,o){for(var e=!0,t=0;t<n.coordinates.length;t++){var r=booleanPointInPolygon(n.coordinates[1],o);if(!r){e=!1;break}r=booleanPointInPolygon(n.coordinates[1],o,{ignoreBoundary:!0})}return e&&r}function isLineOnLine(n,o){for(var e=0;e<n.coordinates.length;e++)if(!booleanPointOnLine(n.coordinates[e],o))return!1;return!0}function isLineInPoly(n,o){if(!doBBoxOverlap(calcBbox(o),calcBbox(n)))return!1;for(var e=!1,t=0;t<n.coordinates.length-1;t++){if(!booleanPointInPolygon(n.coordinates[t],o))return!1;if(e||(e=booleanPointInPolygon(n.coordinates[t],o,{ignoreBoundary:!0})),!e){var r=getMidpoint(n.coordinates[t],n.coordinates[t+1]);e=booleanPointInPolygon(r,o,{ignoreBoundary:!0})}}return e}function isPolyInPoly(n,o){var e=calcBbox(n);if(!doBBoxOverlap(calcBbox(o),e))return!1;for(var t=0;t<n.coordinates[0].length;t++)if(!booleanPointInPolygon(n.coordinates[0][t],o))return!1;return!0}function doBBoxOverlap(n,o){return!(n[0]>o[0])&&(!(n[2]<o[2])&&(!(n[1]>o[1])&&!(n[3]<o[3])))}function compareCoords(n,o){return n[0]===o[0]&&n[1]===o[1]}function getMidpoint(n,o){return[(n[0]+o[0])/2,(n[1]+o[1])/2]}var calcBbox=_interopDefault(require("@turf/bbox")),booleanPointOnLine=_interopDefault(require("@turf/boolean-point-on-line")),booleanPointInPolygon=_interopDefault(require("@turf/boolean-point-in-polygon")),invariant=require("@turf/invariant");module.exports=booleanWithin,module.exports.default=booleanWithin;

},{"@turf/bbox":1,"@turf/boolean-point-in-polygon":2,"@turf/boolean-point-on-line":3,"@turf/invariant":13}],5:[function(require,module,exports){
...
},{"@turf/helpers":9,"@turf/meta":14}],6:[function(require,module,exports){
...
},{"@turf/helpers":9,"@turf/invariant":13}],7:[function(require,module,exports){
...
},{"@turf/helpers":9,"@turf/invariant":13}],9:[function(require,module,exports){
...
"use strict";function _interopDefault(r){return r&&"object"==typeof r&&"default"in r?r.default:r}function hexGrid(r,e,t){if(t=t||{},!helpers.isObject(t))throw new Error("options is invalid");var i=t.properties||{},o=t.triangles,n=t.mask;if(null===e||void 0===e)throw new Error("cellSide is required");if(!helpers.isNumber(e))throw new Error("cellSide is invalid");if(!r)throw new Error("bbox is required");if(!Array.isArray(r))throw new Error("bbox must be array");if(4!==r.length)throw new Error("bbox must contain 4 numbers");if(n&&-1===["Polygon","MultiPolygon"].indexOf(invariant.getType(n)))throw new Error("options.mask must be a (Multi)Polygon");var s=r[0],a=r[1],u=r[2],h=r[3],l=(a+h)/2,f=(s+u)/2,p=2*e/distance([s,l],[u,l],t),c=p*(u-s),d=2*e/distance([f,a],[f,h],t),v=d*(h-a),w=c/2,x=2*w,b=Math.sqrt(3)/2*v,g=u-s,y=h-a,m=.75*x,E=b,M=(g-x)/(x-w/2),q=Math.floor(M),P=(q*m-w/2-g)/2-w/2+m/2,D=Math.floor((y-b)/b),G=(y-D*b)/2,T=D*b-y>b/2;T&&(G-=b/4);for(var _=[],j=[],k=0;k<6;k++){var A=2*Math.PI/6*k;_.push(Math.cos(A)),j.push(Math.sin(A))}for(var O=[],S=0;S<=q;S++)for(var C=0;C<=D;C++){var I=S%2==1;if((0!==C||!I)&&(0!==C||!T)){var N=S*m+s-P,z=C*E+a+G;if(I&&(z-=b/2),!0===o)hexTriangles([N,z],c/2,v/2,i,_,j).forEach(function(r){n?intersect(n,r)&&O.push(r):O.push(r)});else{var B=hexagon([N,z],c/2,v/2,i,_,j);n?intersect(n,B)&&O.push(B):O.push(B)}}}return helpers.featureCollection(O)}function hexagon(r,e,t,i,o,n){for(var s=[],a=0;a<6;a++){var u=r[0]+e*o[a],h=r[1]+t*n[a];s.push([u,h])}return s.push(s[0].slice()),helpers.polygon([s],i)}function hexTriangles(r,e,t,i,o,n){for(var s=[],a=0;a<6;a++){var u=[];u.push(r),u.push([r[0]+e*o[a],r[1]+t*n[a]]),u.push([r[0]+e*o[(a+1)%6],r[1]+t*n[(a+1)%6]]),u.push(r),s.push(helpers.polygon([u],i))}return s}var distance=_interopDefault(require("@turf/distance")),intersect=_interopDefault(require("@turf/intersect")),invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=hexGrid,module.exports.default=hexGrid;

},{"@turf/distance":8,"@turf/helpers":9,"@turf/intersect":12,"@turf/invariant":13}],11:[function(require,module,exports){
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function interpolate(e,r,t){if("object"!=typeof(t=t||{}))throw new Error("options is invalid");var i=t.gridType,o=t.property,a=t.weight;if(!e)throw new Error("points is required");if(invariant.collectionOf(e,"Point","input must contain Points"),!r)throw new Error("cellSize is required");if(void 0!==a&&"number"!=typeof a)throw new Error("weight must be a number");o=o||"elevation",i=i||"square",a=a||1;var n,u=bbox(e);switch(i){case"point":case"points":n=pointGrid(u,r,t);break;case"square":case"squares":n=squareGrid(u,r,t);break;case"hex":case"hexes":n=hexGrid(u,r,t);break;case"triangle":case"triangles":n=triangleGrid(u,r,t);break;default:throw new Error("invalid gridType")}var s=[];return meta.featureEach(n,function(r){var n=0,u=0;meta.featureEach(e,function(e){var s,f="point"===i?r:centroid(r),l=distance(f,e,t);if(void 0!==o&&(s=e.properties[o]),void 0===s&&(s=e.geometry.coordinates[2]),void 0===s)throw new Error("zValue is missing");0===l&&(n=s);var p=1/Math.pow(l,a);u+=p,n+=p*s});var f=clone(r);f.properties[o]=n/u,s.push(f)}),helpers.featureCollection(s)}var bbox=_interopDefault(require("@turf/bbox")),hexGrid=_interopDefault(require("@turf/hex-grid")),pointGrid=_interopDefault(require("@turf/point-grid")),distance=_interopDefault(require("@turf/distance")),centroid=_interopDefault(require("@turf/centroid")),squareGrid=_interopDefault(require("@turf/square-grid")),triangleGrid=_interopDefault(require("@turf/triangle-grid")),clone=_interopDefault(require("@turf/clone")),helpers=require("@turf/helpers"),meta=require("@turf/meta"),invariant=require("@turf/invariant");module.exports=interpolate,module.exports.default=interpolate;

},{"@turf/bbox":1,"@turf/centroid":5,"@turf/clone":7,"@turf/distance":8,"@turf/helpers":9,"@turf/hex-grid":10,"@turf/invariant":13,"@turf/meta":14,"@turf/point-grid":15,"@turf/square-grid":16,"@turf/triangle-grid":17}],12:[function(require,module,exports){
...
},{"@turf/clean-coords":6,"@turf/helpers":9,"@turf/invariant":13,"@turf/truncate":18,"turf-jsts":19}],13:[function(require,module,exports){
...
"use strict";function _interopDefault(r){return r&&"object"==typeof r&&"default"in r?r.default:r}function pointGrid(r,e,i){if(i=i||{},!helpers.isObject(i))throw new Error("options is invalid");var t=i.mask,o=i.properties,n=[];if(null===e||void 0===e)throw new Error("cellSide is required");if(!helpers.isNumber(e))throw new Error("cellSide is invalid");if(!r)throw new Error("bbox is required");if(!Array.isArray(r))throw new Error("bbox must be array");if(4!==r.length)throw new Error("bbox must contain 4 numbers");if(t&&-1===["Polygon","MultiPolygon"].indexOf(invariant.getType(t)))throw new Error("options.mask must be a (Multi)Polygon");for(var a=r[0],u=r[1],l=r[2],s=r[3],f=e/distance([a,u],[l,u],i),p=f*(l-a),h=e/distance([a,u],[a,s],i),d=h*(s-u),w=l-a,b=s-u,c=Math.floor(w/p),v=Math.floor(b/d),m=(w-c*p)/2,y=(b-v*d)/2,E=a+m;E<=l;){for(var q=u+y;q<=s;){var x=helpers.point([E,q],o);t?within(x,t)&&n.push(x):n.push(x),q+=d}E+=p}return helpers.featureCollection(n)}var within=_interopDefault(require("@turf/boolean-within")),distance=_interopDefault(require("@turf/distance")),invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=pointGrid,module.exports.default=pointGrid;

},{"@turf/boolean-within":4,"@turf/distance":8,"@turf/helpers":9,"@turf/invariant":13}],16:[function(require,module,exports){
"use strict";function _interopDefault(r){return r&&"object"==typeof r&&"default"in r?r.default:r}function squareGrid(r,e,t){if(t=t||{},!helpers.isObject(t))throw new Error("options is invalid");var i=t.properties,o=t.mask,n=[];if(null===e||void 0===e)throw new Error("cellSide is required");if(!helpers.isNumber(e))throw new Error("cellSide is invalid");if(!r)throw new Error("bbox is required");if(!Array.isArray(r))throw new Error("bbox must be array");if(4!==r.length)throw new Error("bbox must contain 4 numbers");if(o&&-1===["Polygon","MultiPolygon"].indexOf(invariant.getType(o)))throw new Error("options.mask must be a (Multi)Polygon");for(var s=r[0],a=r[1],u=r[2],l=r[3],f=e/distance([s,a],[u,a],t),d=f*(u-s),p=e/distance([s,a],[s,l],t),h=p*(l-a),c=u-s,w=l-a,b=Math.floor(c/d),v=Math.floor(w/h),m=(c-b*d)/2,q=(w-v*h)/2,y=s+m,E=0;E<b;E++){for(var g=a+q,x=0;x<v;x++){var M=helpers.polygon([[[y,g],[y,g+h],[y+d,g+h],[y+d,g],[y,g]]],i);o?intersect(o,M)&&n.push(M):n.push(M),g+=h}y+=d}return helpers.featureCollection(n)}var distance=_interopDefault(require("@turf/distance")),intersect=_interopDefault(require("@turf/intersect")),invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=squareGrid,module.exports.default=squareGrid;

},{"@turf/distance":8,"@turf/helpers":9,"@turf/intersect":12,"@turf/invariant":13}],17:[function(require,module,exports){
"use strict";function _interopDefault(r){return r&&"object"==typeof r&&"default"in r?r.default:r}function triangleGrid(r,e,i){if(i=i||{},!helpers.isObject(i))throw new Error("options is invalid");var t=i.properties,o=i.mask,n=[];if(null===e||void 0===e)throw new Error("cellSide is required");if(!helpers.isNumber(e))throw new Error("cellSide is invalid");if(!r)throw new Error("bbox is required");if(!Array.isArray(r))throw new Error("bbox must be array");if(4!==r.length)throw new Error("bbox must contain 4 numbers");if(o&&-1===["Polygon","MultiPolygon"].indexOf(invariant.getType(o)))throw new Error("options.mask must be a (Multi)Polygon");for(var l=e/distance([r[0],r[1]],[r[2],r[1]],i),s=l*(r[2]-r[0]),u=e/distance([r[0],r[1]],[r[0],r[3]],i),p=u*(r[3]-r[1]),a=0,h=r[0];h<=r[2];){for(var f=0,d=r[1];d<=r[3];){var c=null,g=null;a%2==0&&f%2==0?(c=helpers.polygon([[[h,d],[h,d+p],[h+s,d],[h,d]]],t),g=helpers.polygon([[[h,d+p],[h+s,d+p],[h+s,d],[h,d+p]]],t)):a%2==0&&f%2==1?(c=helpers.polygon([[[h,d],[h+s,d+p],[h+s,d],[h,d]]],t),g=helpers.polygon([[[h,d],[h,d+p],[h+s,d+p],[h,d]]],t)):f%2==0&&a%2==1?(c=helpers.polygon([[[h,d],[h,d+p],[h+s,d+p],[h,d]]],t),g=helpers.polygon([[[h,d],[h+s,d+p],[h+s,d],[h,d]]],t)):f%2==1&&a%2==1&&(c=helpers.polygon([[[h,d],[h,d+p],[h+s,d],[h,d]]],t),g=helpers.polygon([[[h,d+p],[h+s,d+p],[h+s,d],[h,d+p]]],t)),o?(intersect(o,c)&&n.push(c),intersect(o,g)&&n.push(g)):(n.push(c),n.push(g)),d+=p,f++}a++,h+=s}return helpers.featureCollection(n)}var distance=_interopDefault(require("@turf/distance")),intersect=_interopDefault(require("@turf/intersect")),invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=triangleGrid,module.exports.default=triangleGrid;

},{"@turf/distance":8,"@turf/helpers":9,"@turf/intersect":12,"@turf/invariant":13}],18:[function(require,module,exports){
...
},{"@turf/helpers":9,"@turf/meta":14}],19:[function(require,module,exports){
...
module.exports={bbox:require("@turf/bbox"),hexGrid:require("@turf/hex-grid"),pointGrid:require("@turf/point-grid"),distance:require("@turf/distance"),centroid:require("@turf/centroid"),squareGrid:require("@turf/square-grid"),triangleGrid:require("@turf/triangle-grid"),clone:require("@turf/clone"),helpers:require("@turf/helpers"),meta:require("@turf/meta"),invariant:require("@turf/invariant"),truncate:require("@turf/truncate"),interpolate:require("@turf/interpolate")};
},{"@turf/bbox":1,"@turf/centroid":5,"@turf/clone":7,"@turf/distance":8,"@turf/helpers":9,"@turf/hex-grid":10,"@turf/interpolate":11,"@turf/invariant":13,"@turf/meta":14,"@turf/point-grid":15,"@turf/square-grid":16,"@turf/triangle-grid":17,"@turf/truncate":18}]},{},[20])(20)
});
